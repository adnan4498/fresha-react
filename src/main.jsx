...
import MakeAppointment from "./pages/bookings/MakeAppointment";
...
const router = createBrowserRouter([
  ...
  {
    path: "/dynamic-category/:category/:city/:name/bookingService/professionalWithService/makeAppointment",
