...
export const handleSelectingSpecialistInDrawer = function (
  ...
  // console.log(selectedSpecialistInDrawer, "selectedSpecialistInDrawer 22");
  console.log("selectedSpecialistInDrawer 22");

  // let selectedSpecialistArr = selectedSpecialistInDrawer || salonDataZustand.selectedSpecialists;
  let selectedSpecialistArr = salonDataZustand.selectedSpecialists;
